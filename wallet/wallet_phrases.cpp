...
phrase lng_wallet_intro_title = "TONCommunity.org Wallet";
phrase lng_wallet_intro_description = "TONCommunity.org Wallet allows you to make fast and\nsecure blockchain-based payments\nwithout intermediaries.";
...
phrase lng_wallet_created_description = "Your TONCommunity.org Wallet has just been created.\nOnly you control it.\n\nTo be able to always have access to it,\nplease set up a secure password and write\ndown secret words.";
...
phrase lng_wallet_cover_receive_full = "Receive TONCommunity Coins";
...
phrase lng_wallet_view_send_to_address = "Send TONCommunity Coins to this address";
phrase lng_wallet_view_send_to_recipient = "Send TONCommunity Coins to this Recipient";

phrase lng_wallet_receive_title = "Receive TONCommunity Coins";
phrase lng_wallet_receive_description = "Share this address with other TONCommunity.org Wallet owners to receive TONCommunity Coins from them.";
phrase lng_wallet_receive_description_test = "Share this address to receive Test TONCommunity Coins. Note: this link won't work for real TONCommunity Coins.";
...
phrase lng_wallet_invoice_number = "Amount in TONCommunity Coins you expect to receive";
...
phrase lng_wallet_invoice_url_about = "Share this address with other TONCommunity.org Wallet owners to receive TONCommunity Coins from them.";
phrase lng_wallet_invoice_url_about_test = "Share this address to receive Test TONCommunity Coins. Note: this link won't work for real TONCommunity Coins.";
...
phrase lng_wallet_send_button = "Send TONCommunity Coins";
...
phrase lng_wallet_confirm_send = "Send TONCommunity Coins";
...
phrase lng_wallet_same_address_text = "Sending TONCommunity Coins from a wallet to the same wallet doesn't make sense, you will simply waste a portion of the value on blockchain fees.";
...
phrase lng_wallet_sending_title = "Sending TONCommunity Coins";
...
phrase lng_wallet_warning_to_testnet = "Are you sure you want to switch to the Test TONCommunity.org network? It exists only for testing purposes.";
phrase lng_wallet_warning_to_mainnet = "Are you sure you want to switch to the Main TONCommunity.org network? TONCommunity Coins will have real value there.";
...
Fn<phrase(QString)> lng_wallet_grams_count = [](QString text) {
	return text + ((text == "1") ? " TONCommunity Coin" : " TONCommunity Coins");
};

Fn<phrase(QString)> lng_wallet_grams_count_sent = [](QString text) {
	return text + ((text == "1")
		? " TONCommunity Coin has been sent."
		: " TONCommunity Coins have been sent.");
};
